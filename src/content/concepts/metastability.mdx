...
genealogy:
  ...
  - "Prigogine 1984"
notThis:
  - Not unstable — unstable systems collapse rapidly without crossing a threshold.
  - Not near-equilibrium.
  - Not steady-state.
  - Not a kind of dynamism in general.
whereNext:
  - kind: concept
    slug: transduction
    why: how a metastable field discharges
  - kind: concept
    slug: individuation
    why: what precipitates from the field
  - kind: concept
    slug: the-virtual
    why: the structured charge the field carries
